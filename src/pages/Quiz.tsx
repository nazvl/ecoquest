...
function Quiz() {
  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        {
          text: "Сумма всех выбросов CO2 и других парниковых газов, вызванных деятельностью человека",
          isCorrect: true,
        },
    ...
    {
      question:
        "Какой из этих продуктов оказывает наименьшее воздействие на окружающую среду?",
      answers: [
    ...
    },
    {
      ...
      answers: [
        {
          text: "Процесс превращения отходов в новые продукты или материалы",
          isCorrect: true,
        },
    ...
    {
      question:
        "Какой из этих видов энергии является наиболее экологически чистым?",
      answers: [
    ...
    },
    {
      ...
      answers: [
        {
          text: "Документ, подтверждающий использование экологически чистых технологий",
          isCorrect: true,
        },
        {
          text: "Подарочный сертификат для экологичных товаров",
          isCorrect: false,
        },
        {
          text: "Сертификат, подтверждающий продукцию из органических материалов",
          isCorrect: false,
        },
    ...
    },
    {
      ...
      answers: [
        {
          text: "Производит кислород и поглощает углекислый газ",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      answers: [
        {
          text: "Использовать одноразовую пластиковую посуду",
          isCorrect: false,
        },
    ...
    {
      question:
        "Какой способ сокращения углеродного следа является наиболее эффективным?",
      answers: [
    ...
    },
    {
      ...
      answers: [
        {
          text: "Развитие, которое удовлетворяет потребности текущего поколения, не ущемляя возможности будущих поколений",
          isCorrect: true,
        },
        { text: "Рост экономики без учета экологии", isCorrect: false },
        {
          text: "Использование новых технологий, независимо от их воздействия на природу",
          isCorrect: false,
        },
        {
          text: "Полный отказ от использования природных ресурсов",
          isCorrect: false,
        },
      ],
    },
        ...
        >
          <div className="bg-green-600 py-4 px-6">
            <h1 className="text-xl md:text-2xl font-bold text-white text-center">
              Экологический квиз{" "}
              <RecyclingIcon className="inline-block w-5 h-5 md:w-6 md:h-6" />
            </h1>
          </div>
            ...
            <div className="results-container flex flex-col items-center p-4 md:p-8 gap-4 md:gap-6">
              ...
              {score < questions.length / 2 ? (
                <div className="text-center">
                  <p className="text-base md:text-lg text-red-600 mb-3">
                    Узнайте больше о защите окружающей среды и попробуйте снова!
                  </p>
                  <p>
                    <span
