  ...
  return (
    <>
      <motion.div
        ...
        id="main"
        className="quiz-main w-full min-h-[99vh] bg-gradient-to-b from-green-100 to-green-50 flex flex-col sm:py-8 md:flex-row gap-6 md:gap-10 items-center justify-center py-8 px-4 md:px-8"
      >
