      ...
      <div className="bg-white p-6 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {tips.map((section, index) => (
            <div key={index} className="bg-white rounded-lg transition-transform duration-200 hover:scale-[1.02]">
              <div className="p-5">
                <div className="flex items-center mb-4">
                  {section.icon}
                  <h2 className="text-xl font-medium ml-2">{section.category}</h2>
                </div>
        ...
        <div className="mt-10 p-5 bg-green-50 rounded-lg">
          ...
          <p className="text-center text-gray-700">
            Даже самые маленькие действия важны. Начните с малого, и вместе мы сможем сделать нашу планету чище и здоровее!
          </p>
        </div>
      </div>
    </div>
