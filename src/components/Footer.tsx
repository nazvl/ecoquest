      ...
      <div className="max-w-6xl mx-auto flex flex-wrap justify-between px-4">
          ...
          <ul className="list-none p-0">
            <li className="mb-2">
              <span
                ...
                className="text-gray-200 no-underline hover:text-emerald-300 transition-colors cursor-pointer"
              >
                Начало
              </span>
            </li>
        ...
        <div className="flex-1 min-w-[250px] mb-6">
          ...
          <div className="flex gap-4">
            <a
              href="https://github.com/nazvl"
              aria-label="GitHub"
              className="text-gray-200 text-2xl hover:text-emerald-300 transition-colors"
            >
              <FaGithub />
            </a>
          </div>
