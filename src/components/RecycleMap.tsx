...
const RecycleMap: React.FC = () => {
        ...
        window.ymaps.ready(() => {
          try {
            ...
            searchButton.events.add("click", () => {
              ...
              window.ymaps
                .geocode("Приём и скупка вторсырья Белгород", {
                  results: 20,
              ...
              const placemark = new window.ymaps.Placemark(
                coordinates,
                {
                  ...
                  balloonContentBody:
                    ...
                    (acceptedItems
                      ? `<p><strong>Принимает:</strong> ${acceptedItems.join(
                          ", "
                        )}</p>`
                      : ""),
                },
            ...
            addRecyclePoint([50.594, 36.5865], "Экоцентр", "ул. Щорса, 8", [
              "Бумага",
              "Пластик",
              "Металл",
              "Стекло",
            ...
            window.ymaps
              .geocode("Пункты приема вторсырья Белгород", {
                results: 15,
              })
              .then((res: any) => {
                // Process results
  ...
  return (
    <div className="flex flex-col w-full max-w-6xl h-[90vh] mx-auto p-5 rounded-lg  shadow-lg">
      <h2 className="text-center text-2xl md:text-3xl font-bold text-green-700 mb-5">
