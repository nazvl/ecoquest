    ...
    const adjustOverlay = () => {
      ...
      if (mapElement && overlay) {
        ...
        Object.assign((overlay as HTMLElement).style, {
          ...
          top: `${
            rect.top -
            (mapContainerRef.current?.getBoundingClientRect().top || 0)
          }px`,
          left: `${
            rect.left -
            (mapContainerRef.current?.getBoundingClientRect().left || 0)
          }px`,
        });
      }
    };
    ...
    <section id="map" className="w-full bg-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center mt-4 text-gray-600">
          Выберите пункт на карте, чтобы узнать подробности о принимаемых
          материалах.
        </p>
      </div>
    </section>
